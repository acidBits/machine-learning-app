...
with st.sidebar:
  ...
  flipper_length_mm = st.slider('flipper_length(mm):', df['flipper_length_mm'].min(), df['flipper_length_mm'].max(), df['flipper_length_mm'].mean())
  body_mass_g = st.slider('body_mass(g)', df['body_mass_g'].min(), df['body_mass_g'].max(), df['body_mass_g'].mean())
